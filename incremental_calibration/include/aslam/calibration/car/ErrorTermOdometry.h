...
/** \file ErrorTermOdometry.h
    \brief This file defines the ErrorTermOdometry class, which implements
           an error term for the car odometry.
  */

#ifndef ASLAM_CALIBRATION_CAR_ERROR_TERM_ODOMETRY_H
#define ASLAM_CALIBRATION_CAR_ERROR_TERM_ODOMETRY_H
...
namespace aslam {
  namespace calibration {
    ...
    /** The class ErrorTermOdometry implements an error term for the car
      ...
      */
    class ErrorTermOdometry :
      public aslam::backend::ErrorTermFs<5> {
    public:
      ...
      /** \name Types definitions
        ...
        */
      /// Covariance type
      typedef Eigen::Matrix<double, 5, 5> Covariance;
      /// Measurement type
      typedef Eigen::Matrix<double, 5, 1> Input;
      /** @}
        */
      ...
      /// Assignment operator
      ErrorTermOdometry& operator = (const ErrorTermOdometry& other);
      /// Destructor
      virtual ~ErrorTermOdometry();
      /** @}
        */
...
#endif // ASLAM_CALIBRATION_CAR_ERROR_TERM_ODOMETRY_H
