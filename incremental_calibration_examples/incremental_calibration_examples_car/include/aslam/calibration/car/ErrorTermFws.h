...
/** \file ErrorTermFws.h
    \brief This file defines the ErrorTermFws class, which implements
           an error term for the front wheel speeds.
  */

#ifndef ASLAM_CALIBRATION_CAR_ERROR_TERM_FWS_H
#define ASLAM_CALIBRATION_CAR_ERROR_TERM_FWS_H
...
namespace aslam {
  namespace calibration {
    ...
    public:
      ...
      /// Copy constructor
      ErrorTermFws(const ErrorTermFws& other);
      /// Assignment operator
      ErrorTermFws& operator = (const ErrorTermFws& other);
      /// Destructor
      virtual ~ErrorTermFws();
      /** @}
        */
...
#endif // ASLAM_CALIBRATION_CAR_ERROR_TERM_FWS_H
