...
/** \file ErrorTermPose.h
    \brief This file defines the ErrorTermPose class, which implements an error
           term for a pose sensor.
  */

#ifndef ASLAM_CALIBRATION_TIME_DELAY_ERROR_TERM_POSE_H
#define ASLAM_CALIBRATION_TIME_DELAY_ERROR_TERM_POSE_H
...
namespace aslam {
  namespace calibration {
    ...
    public:
       ...
       */
      ErrorTermPose(const aslam::backend::TransformationExpression& T, const
        Input& Tm, const Covariance& sigma2);
      /// Copy constructor
...
#endif // ASLAM_CALIBRATION_TIME_DELAY_ERROR_TERM_POSE_H
